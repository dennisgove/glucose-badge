...
public class Transmitter: BluetoothManagerDelegate {
    ...
    private func authenticate() throws {
            ...
            status = AuthStatusRxMessage(data: data) where status.authenticated == 1 && status.bonded == 1
        {
            ...
            do {
                ...
                throw TransmitterError.AuthenticationError("Error enabling notification 1: \(error)")
            }
    ...
    private func control() throws {
        do {
            ...
            throw TransmitterError.ControlError("Error enabling notification 2: \(error)")
        }
    ...
    private func listenToControl() throws {
        do {
            ...
            throw TransmitterError.ControlError("Error enabling notification 3: \(error)")
        }
